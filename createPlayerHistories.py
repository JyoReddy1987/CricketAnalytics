...
next_tournament = "The Masters"
year = 2015
tournament_link = 'masters-tournament'
...
for pga_name in field:
    ...
    print pga_name
    if pga_name in ['Ben Crenshaw','Matias Dominguez','Scott Harvey']: continue
...
k2 = Key(b)
k2.key = 'sportsData/' + str(year) + '/' + next_tournament + '/history.json'
